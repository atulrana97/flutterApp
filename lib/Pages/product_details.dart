  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            footer: Container(
              ...
              child: ListTile(
                ...
                title: Row(children: <Widget>[
                  Expanded(
                    child: Text(widget.productDetailsOldPrice,style: TextStyle(
                      fontSize: 20, 
                      color: Colors.grey,
      ...
      ListTile(
        ...
        subtitle: Text("Cookie is a term used for sweet, flat, baked goods. Biscuit is a term used for a variety of baked, mainly flour-based food products. ... The term cookie is mostly used in American English. In British English, the term biscuit refers to a small, baked, unleavened cake, which is typically crisp, flat, and sweet."),
        ),
      Divider(color: Colors.redAccent,),
            ...
            child: GridTile(
              footer: Container(
                ...
                child: ListTile(
                  ...
                  title: Text(productPrice, style: TextStyle(
                    color: Colors.redAccent,
                    fontWeight: FontWeight.w800,
                    ),
                    ), 
                    subtitle: Text(productOldprice, style: TextStyle(
